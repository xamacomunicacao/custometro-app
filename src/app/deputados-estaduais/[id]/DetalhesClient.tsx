    ...
    <main className="w-full min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      <section className="relative z-20 max-w-5xl mx-auto px-6 md:px-12 py-10 flex flex-col items-center">
            ...
            despesas.map((despesa, index) => (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 w-full md:w-auto">
                  ...
                  <a 
                    href={despesa.linkOriginal && despesa.linkOriginal !== "https://transparencia.am.gov.br/" ? despesa.linkOriginal : "https://www.aleam.gov.br/transparencia/controle-de-cota-parlamentar/"} 
                    target="_blank" 
        ...
        <div className="text-center mb-8">
          ...
          <a href="https://www.aleam.gov.br/transparencia/controle-de-cota-parlamentar/" target="_blank" rel="noopener noreferrer" className="mt-4 text-[#1C2331] text-[16px] font-medium hover:text-[#FF0055] transition-colors flex items-center justify-center gap-2 mx-auto">
